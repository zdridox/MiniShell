...
/*   Updated: 2026/07/04 22:47:55 by mamelnyk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*expand_redirect_target_str(t_word *redirect_word, t_shell *shell)
{
	char	**expanded_argv;
	char	*expanded_str;
...
bool	expand_words_in_redirects(t_redirect_node *redirects, t_shell *shell)
{
	while (redirects)
	{
		redirects->target_str = expand_redirect_target_str(redirects->target, shell);
