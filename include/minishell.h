...
bool						set_env_variable(char *env_name, char *value,
								char **env);
...
bool						write_heredoc_to_file(char *delimiter,
								char *file_path);
char						*generate_temp_file_path(void *seed);

// ast_expand.c
void						free_ast(t_ast_node *node);
bool						expand_words_in_ast(t_ast_node *node,
								t_shell *shell);
...
void						set_shell_var_value(t_var_arr *varr, char *nm,
								char *vl, t_shell *shell);
...
void						set_shell_var_from_full_var(t_var_arr *varr,
								char *full_var);
void						var_arr_fill(t_var_arr *varr, char **array,
								t_shell *shell);
